...
function uc_user_register($username, $password, $email, $nickname, $phone, $qq, $sex, $birthday) {
	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>$username, 'password'=>$password, 'email'=>$email, 'nickname'=>$nickname, 'phone'=>$phone, 'qq'=>$qq, 'sex'=>$sex, 'birthday'=>$birthday));
}
