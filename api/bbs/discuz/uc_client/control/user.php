...
class usercontrol extends base {
	...
	function onregister($arr) {
		@extract($arr, EXTR_SKIP);//username, password, email, nickname, phone, qq, sex, birthday
		...
		$uid = $_ENV['user']->add_user($username, $password, $email, $nickname, $phone, $qq, $sex, $birthday);
		return $uid;
	}
