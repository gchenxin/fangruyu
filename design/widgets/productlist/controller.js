define(function(require) {
    ...
    c = {
        getCategoryList: "/include/"+Module+".inc.php?action=productType&projectid="+g,
        getProductList: "/include/"+Module+".inc.php?action=productList&projectid="+g
    },
    p = "app-productlist-filter";
    s.createSection(p, {
        initView: function() {
            var t, e = this;
    ...
    F = i({
        setup: function(t) {
            ...
            this.content = $('<ul class="w-productlist-container">loading...</ul>'),
        ...
        loadData: function() {
            ...
            return $.getJSON(c.getProductList + "&jsoncallback=?", {
                projectid: g,
        ...
        buildTpl: function() {
            ...
            if (2 == a ? n = "li-image": 3 == a && (n = "li-group"), e = "", t = '<li class="' + n + '" style="' + e + '">', a > 1) {
                var s = "";
                t += '<div class="image"><a href="product-view.{%id%}.html"><img src="{%image%}"',
                i.imageWidth && (t += ' width="' + i.imageWidth + '"'),
                i.imageHeight && (t += ' height="' + i.imageHeight + '"'),
                t += ' style="' + s + '"/></a></div>'
            }
            return t += '<div class="text"><div class="title">',
            i.showCategory && (t += '<a class="category" href="product-list-{%catid%}.html">[{%catname%}]</a>'),
            t += '<a href="product-view-{%id%}.html">{%title%}</a>',
