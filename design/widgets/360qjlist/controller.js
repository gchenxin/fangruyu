define(function(require) {
    ...
    c = {
        get360qjList: "/include/"+Module+".inc.php?action=360qjList&projectid="+g
    },
    p = "app-360qjlist-filter";
    s.createSection(p, {
        initView: function() {
            var t, e = this;
    ...
    F = i({
        setup: function(t) {
            ...
            this.content = $('<ul class="w-360qjlist-container">loading...</ul>'),
        ...
        loadData: function() {
            ...
            return $.getJSON(c.get360qjList + "&jsoncallback=?", {
                projectid: g,
