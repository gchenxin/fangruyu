define(function(require) {
    ...
    c = {
        getEventList: "/include/"+Module+".inc.php?action=eventList&projectid="+g
    },
    p = "app-eventlist-filter";
    s.createSection(p, {
        initView: function() {
            var t, e = this;
    ...
    F = i({
        setup: function(t) {
            ...
            this.content = $('<ul class="w-eventlist-container">loading...</ul>'),
        ...
        loadData: function() {
            ...
            return $.getJSON(c.getEventList + "&jsoncallback=?", {
                projectid: g,
