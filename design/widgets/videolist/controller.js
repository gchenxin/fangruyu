define(function(require) {
    ...
    c = {
        getVideoList: "/include/"+Module+".inc.php?action=videoList&projectid="+g
    },
    p = "app-videolist-filter";
    s.createSection(p, {
        initView: function() {
            var t, e = this;
    ...
    F = i({
        setup: function(t) {
            ...
            this.content = $('<ul class="w-videolist-container">loading...</ul>'),
        ...
        loadData: function() {
            ...
            return $.getJSON(c.getVideoList + "&jsoncallback=?", {
                projectid: g,
