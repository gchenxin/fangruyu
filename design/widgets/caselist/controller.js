define(function(require) {
    ...
    c = {
        getCaseList: "/include/"+Module+".inc.php?action=caseList&projectid="+g
    },
    p = "app-caselist-filter";
    s.createSection(p, {
        initView: function() {
            var t, e = this;
    ...
    F = i({
        setup: function(t) {
            ...
            this.content = $('<ul class="w-caselist-container">loading...</ul>'),
        ...
        loadData: function() {
            ...
            return $.getJSON(c.getCaseList + "&jsoncallback=?", {
                projectid: g,
