 ...
 * 装修频道配置
 *
 * @version        $Id: renovationConfig.php 2014-2-28 上午11:03:59 $
...
checkPurview("renovationConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__) . "/../templates/renovation";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "renovationConfig.html";

$action = $action == "" ? "renovation" : $action;
...
if ($type != "") {
    ...
    if ($type == "site") {
        ...
        $custom_xq_atlasMax = (int)$xq_atlasMax;
        $custom_gs_atlasMax = (int)$gs_atlasMax;
        $custom_case_atlasMax = (int)$case_atlasMax;
        $custom_diary_atlasMax = (int)$diary_atlasMax;
    ...
    $customInc .= "\$custom_xq_atlasMax = " . $custom_xq_atlasMax . ";\r\n";
    $customInc .= "\$custom_gs_atlasMax = " . $custom_gs_atlasMax . ";\r\n";
    $customInc .= "\$custom_case_atlasMax = " . $custom_case_atlasMax . ";\r\n";
    $customInc .= "\$custom_diary_atlasMax = " . $custom_diary_atlasMax . ";\r\n";
...
if (file_exists($tpl . "/" . $templates)) {
    ...
    $jsFile = array(
        ...
        'publicUpload.js',
        'admin/renovation/renovationConfig.js'
    );
    ...
    $huoniaoTag->assign('xq_atlasMax', $custom_xq_atlasMax);
    $huoniaoTag->assign('gs_atlasMax', $custom_gs_atlasMax);
    $huoniaoTag->assign('case_atlasMax', $custom_case_atlasMax);
    $huoniaoTag->assign('diary_atlasMax', $custom_diary_atlasMax);
