 ...
 * 分类信息频道配置
 *
 * @version        $Id: infoConfig.php 2013-7-7 上午10:33:36 $
...
checkPurview("infoConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__) . "/../templates/info";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "infoConfig.html";
