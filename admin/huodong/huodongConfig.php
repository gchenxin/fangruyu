 ...
 * 活动频道配置
 *
 * @version        $Id: huodongConfig.php 2016-12-22 上午10:57:11 $
...
checkPurview("huodongConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__) . "/../templates/huodong";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "huodongConfig.html";

$action = $action == "" ? "huodong" : $action;
...
if (file_exists($tpl . "/" . $templates)) {
    ...
    $jsFile = array(
        ...
        'publicUpload.js',
        'admin/huodong/huodongConfig.js'
    );
