 ...
 * 投票频道配置
 *
 * @version        $Id: voteConfig.php 2017-1-1 上午10:00:00 $
...
$actiontxt = "投票";
checkPurview($action."Config");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/".$action;
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = $action."Config.html";
