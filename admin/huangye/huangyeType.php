 ...
 * 管理黄页分类
 *
 * @version        $Id: huangyeType.php 2013-11-6 上午11:06:10 $
...
checkPurview("huangyeType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/huangye";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "huangyeType.html";
...
//删除分类
	...
	if($id != ""){
		...
		foreach ($idsArr as $kk => $id) {
			...
			if($res){
				delPicFile($res[0]['icon'], "delAdv", $action);
			}
