 ...
 * 积分商城频道配置
 *
 * @version        $Id: integralConfig.php 2017-11-23 13:50 $
...
checkPurview("integralConfig");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__) . "/../templates/integral";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "integralConfig.html";

$action = $action == "" ? "integral" : $action;
...
if ($type != "") {
    ...
    $customInc .= "\$customPeisong = " . $customPeisong . ";\r\n";
    $customInc .= "\$customShearSettlement = " . $customShearSettlement . ";\r\n";
    $customInc .= "\$customShearSettlementLimit = " . $customShearSettlementLimit . ";\r\n";
    //模板风格
...
if (file_exists($tpl . "/" . $templates)) {
    ...
    $jsFile = array(
        ...
        'publicUpload.js',
        'admin/integral/integralConfig.js'
    );
