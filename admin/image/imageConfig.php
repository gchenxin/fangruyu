 ...
 * 图片频道配置
 *
 * @version        $Id: imageConfig.php 2013-7-7 上午10:33:36 $
...
$templates = "imageConfig.html";

if ($action == "") {
    $action = "image";
}

checkPurview("imageConfig");
...
if ($type != "") {
    ...
    $customInc .= "\$custom_ftpPasv = " . (int)$custom_ftpPasv . ";\r\n";
