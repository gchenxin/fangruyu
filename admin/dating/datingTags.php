 ...
 * 管理标签分类
 *
 * @version        $Id: datingTags.php 2014-7-18 下午17:24:21 $
...
checkPurview("datingTags");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/dating";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "datingTags.html";
