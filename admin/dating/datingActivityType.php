 ...
 * 管理信息分类
 *
 * @version        $Id: datingActivityType.php 2013-11-6 上午11:06:10 $
...
checkPurview("datingActivityType");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/dating";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "datingActivityType.html";

$action = "dating_activity";
...
if(file_exists($tpl."/".$templates)){
	...
	$jsFile = array(
		...
		'admin/dating/datingActivityType.js'
	);
