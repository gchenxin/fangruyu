 ...
 * 管理交友地区
 *
 * @version        $Id: datingAddr.php 2014-1-7 下午22:29:11 $
...
checkPurview("datingAddr");
$dsql = new dsql($dbo);
$tpl = dirname(__FILE__)."/../templates/dating";
$huoniaoTag->template_dir = $tpl; //设置后台模板目录
$templates = "datingAddr.html";
